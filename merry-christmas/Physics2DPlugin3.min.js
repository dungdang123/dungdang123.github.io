! function(n, e) {
    ...
    function s(n) {
        r = n || j(), d || (a = r.utils.getUnit, u = r.core.getStyleSaver, y = r.core.reverting || function() {}, d = 1)
    }

    function t(n, e, t, i, s) {
        var o = n._gsap,
            r = o.get(n, e);
        this.p = e, this.set = o.set(n, e), this.s = this.val = parseFloat(r), this.u = a(r) || 0, this.vel = t || 0, this.v = this.vel / s, i || 0 === i ? (this.acc = i, this.a = this.acc / (s * s)) : this.acc = this.a = 0
    }
    var r, d, a, u, y, v = Math.PI / 180,
        c = "Physics2DPlugin",
        ...
        i = (function(e) {
            ...
            init: function init(n, e, i) {
                ...
                o.styles = u && u(n, e.xProp && "x" !== e.xProp ? e.xProp + "," + e.yProp : "transform"), o.target = n, o.tween = i, o.step = 0, o.sps = 30, e.gravity && (c = +e.gravity, f = 90), r *= v, f *= v, o.fr = 1 - (+e.friction || 0), o._props.push(l, p), o.xp = new t(n, l, Math.cos(r) * a, Math.cos(f) * c, o.sps), o.yp = new t(n, p, Math.sin(r) * a, Math.sin(f) * c, o.sps), o.skipX = o.skipY = 0
            },
