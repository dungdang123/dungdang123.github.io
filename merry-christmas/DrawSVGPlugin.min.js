...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        var e, t = _gsScope.document,
            ...
            g = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
            C = -1 !== ((_gsScope.navigator || {}).userAgent || "").indexOf("Edge"),
            l = {
                rect: ["width", "height"],
                circle: ["r", "r"],
                ellipse: ["rx", "ry"],
        ...
        function y(e) {
            ...
            if (r && (r.width || r.height) || !l[h] || (r = {
                    width: parseFloat(e.getAttribute(l[h][0])),
                    height: parseFloat(e.getAttribute(l[h][1]))
                }, "rect" !== h && "line" !== h && (r.width *= 2, r.height *= 2), "line" === h && (r.x = parseFloat(e.getAttribute("x1")), r.y = parseFloat(e.getAttribute("y1")), r.width = Math.abs(r.width - r.x), r.height = Math.abs(r.height - r.y))), "path" === h) i = e.style.strokeDasharray, e.style.strokeDasharray = "none", t = e.getTotalLength() || 0, f !== d && console.log("Warning: <path> length cannot be measured accurately when vector-effect is non-scaling-stroke and the element isn't proportionally scaled."), t *= (f + d) / 2, e.style.strokeDasharray = i;
                ...
                for (o = e.getAttribute("points").match(g) || [], "polygon" === h && o.push(o[0], o[1]), t = 0, s = 2; s < o.length; s += 2) t += u(o[s - 2], o[s - 1], o[s], o[s + 1], f, d) || 0;
        ...
        function x(e, t) {
            ...
            init: function(e, t, r, o) {
                ...
                if (!w) return window.location.href = "http://" + m + S + "?plugin=" + _ + "&source=codepen", !1;
                var i, s, n, a, h, f, d, g, l, u, c = y(e) + 1;
            ...
            set: function(e) {
                var t, r;
                this._firstPT && (!this._live || (t = y(this._target) + 11) !== this._length && (r = t / this._length, this._length = t, this._offsetPT.s *= r, this._offsetPT.c *= r, this._dashPT ? (this._dashPT.s *= r, this._dashPT.c *= r) : this._dash *= r), this._super.setRatio.call(this, e), this._style.strokeDashoffset = this._offset, this._style.strokeDasharray = 1 === e || 0 === e ? this._offset < .001 && this._length - this._dash <= 10 ? "none" : this._offset === this._dash ? "0px, 999999px" : this._dash + "px," + this._length + "px" : this._dash + "px," + this._length + "px")
            }
