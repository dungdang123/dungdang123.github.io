...
! function(t, e) {
    ...
    function measureSegment(t, e, n) {
        ...
        var r, a, o, i, s, l, h, u, f, g, c, p, d, m, v, y, x, w = ~~t.resolution || 12,
            P = 1 / w,
        ...
        for (T.length = C.length = 0, a = e + 2; a < b; a += 6) {
            if (o = t[a + 4] - M, i = t[a + 2] - M, s = t[a] - M, u = t[a + 5] - R, f = t[a + 3] - R, g = t[a + 1] - R, l = h = c = p = 0, H(o) < .01 && H(u) < .01 && H(s) + H(g) < .01) 8 < t.length && (t.splice(a, 6), a -= 6, b -= 6);
            else
                for (r = 1; r <= w; r++) l = h - (h = ((m = P * r) * m * o + 3 * (d = 1 - m) * (m * i + d * s)) * m), c = p - (p = (m * m * u + 3 * d * (m * f + d * g)) * m), (y = $(c * c + l * l)) < S && (S = y), N += y, T[L++] = N;
            M += o, R += u
        }
        if (_)
    ...
    function stringToRawPath(t) {
        ...
        for (e = 0; e < w; e++)
        ...
        else if ("S" === o) u = y, f = x, "C" !== c && "S" !== c || (u += y - s[s.length - 4], f += x - s[s.length - 3]), i || (y = x = 0), s.push(u, f, r, a, y += 1 * m[e + 3], x += 1 * m[e + 4]), e += 4;
        else if ("Q" === o) u = y + 2 / 3 * (r - y), f = x + 2 / 3 * (a - x), i || (y = x = 0), y += 1 * m[e + 3], x += 1 * m[e + 4], s.push(u, f, y + 2 / 3 * (r - y), x + 2 / 3 * (a - x), y, x), e += 4;
        else if ("T" === o) u = y - s[s.length - 4], f = x - s[s.length - 3], s.push(y + u, x + f, r + 2 / 3 * (y + 1.5 * u - r), a + 2 / 3 * (x + 1.5 * f - a), y = r, x = a), e += 2;
            ...
            if (p = m[e + 4], d = m[e + 5], u = m[e + 6], f = m[e + 7], n = 7, 1 < p.length && (p.length < 3 ? (f = u, u = d, n--) : (f = d, u = p.substr(2), n -= 2), d = p.charAt(1), p = p.charAt(0)), g = arcToSegment(y, x, +m[e + 1], +m[e + 2], +m[e + 3], +p, +d, (i ? y : 0) + 1 * u, (i ? x : 0) + 1 * f), e += n, g)
    ...
    function pointsToSegment(t, e) {
        ...
        var n, r, a, o, i, s, l, h, u, f, g, c, p, d, m = t.length - 2,
            v = +t[0],
            y = +t[1],
            x = +t[2],
            w = +t[3],
    ...
    function aa(t, e) {
        ...
        if (u.length || u.push(Z(t, 1), Z(t, 2), Z(t, 3)), n = l ? b : g, l) h ? (o = -(a = function _getCTM(t) {
            ...
            return e
        }(r) : r.getItem(0).matrix : E).a * a.x + r.c * a.y, i = r.b * a.x + r.d * a.y) : (r = new Y, o = i = 0), e && "g" === t.tagName.toLowerCase() && (o = i = 0), (h ? l : f).appendChild(n), n.setAttribute("transform", "matrix(" + r.a + "," + r.b + "," + r.c + "," + r.d + "," + (r.e + o) + "," + (r.f + i) + ")");
        else {
            if (o = i = 0, D)
    ...
    var c, v, w, P, g, b, E, I, D, n, k = "transform",
        z = k + "Origin",
        G = [],
        q = [],
    ...
    var j, f, Q, W, J, o, K = "x,translateX,left,marginLeft,xPercent".split(","),
        ...
        a = {
            ...
            register: function register(t, e, n) {
                Q = (j = t).utils.getUnit, W = j.utils.toArray, J = j.core.getStyleSaver, o = j.core.reverting || function() {}, f = n
            },
